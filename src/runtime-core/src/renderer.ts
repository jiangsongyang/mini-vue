...
export function createRenderer(options) {
  ...
  function patchKeyedChildren(
    ...
    // 乱序
      ...
      console.log('生成的最长递增子序列为 : ', increasingNewIndexSequence)
      console.log('映射表为 : ', newIndexToOldIndexMap)
