...
function createGetter(isReadOnly = false, shallow = false) {
    return function get(target, key) {
        ...
        // 则提前 return
        if (key === exports.REACTIVE_FLAGS.IS_REACTIVE) {
            return !isReadOnly;
        }
        else if (key === exports.REACTIVE_FLAGS.IS_READONLY) {
            return isReadOnly;
        }
...
function isReactive(value) {
    return !!value[exports.REACTIVE_FLAGS.IS_REACTIVE];
}
function isReadOnly(value) {
    return !!value[exports.REACTIVE_FLAGS.IS_READONLY];
}
